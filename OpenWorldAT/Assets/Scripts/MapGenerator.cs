...
public class WorldData
    ...
    public void GenerateMap() 
    {
        ...
        display.DrawMesh(meshGenerator.GenerateTerrainChunk(noiseMap, 2, 0), TextureGenerator.TextureFromColourMap(colourMap, world.MapWidth, world.MapHeight), -x_value * 0, -z_value, -y_value * 2);
        display.DrawMesh(meshGenerator.GenerateTerrainChunk(noiseMap, 2, 1), TextureGenerator.TextureFromColourMap(colourMap, world.MapWidth, world.MapHeight), -x_value * 1, -z_value, -y_value * 2);
        display.DrawMesh(meshGenerator.GenerateTerrainChunk(noiseMap, 2, 2), TextureGenerator.TextureFromColourMap(colourMap, world.MapWidth, world.MapHeight), -x_value * 2, -z_value, -y_value * 2);
        display.DrawMesh(meshGenerator.GenerateTerrainChunk(noiseMap, 2, 3), TextureGenerator.TextureFromColourMap(colourMap, world.MapWidth, world.MapHeight), -x_value * 3, -z_value, -y_value * 2);
        display.DrawMesh(meshGenerator.GenerateTerrainChunk(noiseMap, 3, 0), TextureGenerator.TextureFromColourMap(colourMap, world.MapWidth, world.MapHeight), -x_value * 0, -z_value, -y_value * 3);
        display.DrawMesh(meshGenerator.GenerateTerrainChunk(noiseMap, 3, 1), TextureGenerator.TextureFromColourMap(colourMap, world.MapWidth, world.MapHeight), -x_value * 1, -z_value, -y_value * 3);
        display.DrawMesh(meshGenerator.GenerateTerrainChunk(noiseMap, 3, 2), TextureGenerator.TextureFromColourMap(colourMap, world.MapWidth, world.MapHeight), -x_value * 2, -z_value, -y_value * 3);
        display.DrawMesh(meshGenerator.GenerateTerrainChunk(noiseMap, 3, 3), TextureGenerator.TextureFromColourMap(colourMap, world.MapWidth, world.MapHeight), -x_value * 3, -z_value, -y_value * 3);
